...
for i in range(1):
    for M, N, block_M, block_N, split_dim, dtype in test_configs:
        ...
        passed, ratio, max_abs = _check_precision(tile_grad, ascend_grad, tile_grad.dtype)
        assert passed, f"dtype={tile_grad.dtype}, matched_ratio={ratio:.4f}, max_abs_error={max_abs:.6e}"
